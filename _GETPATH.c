 ...
 * @pstr: pointer to string in previous first node
 * Return: address of the new element/node
 */

list_path *nodeend(list_path **head, char *pstr)
{
 ...
 */
char *_FPATH(char *fname, list_path *head)
{
	struct stat st;
	char *string;
